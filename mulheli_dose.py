...
conditions = [
              Condition.Condition(uname="lys-1A-1um",
                        pucks_and_pins=[
                                        # Selected good crystals
                                        ["CPS1716", [1,2,3]],
                                       ],
                        ...
                        distance=120.0, #[mm]
                        att_raster=1200.0, #[um] # Raster attenuator
                        shika_minscore=30,
                        shika_mindist=0,
                        loop_size="small",
                        helical_hbeam=1.0,
              ...
              Condition.Condition(uname="lys-1A-2um",
                        pucks_and_pins=[
					# Selected good crystals
                                        ["CPS1716", [4,5,6]],
                                       ],
			...
			phosec=2.5E12,
              ...
              Condition.Condition(uname="lys-1A-5um",
                        pucks_and_pins=[
					# Selected good crystals
                                        ["CPS1716", [7,8,9]],
                                       ],
			...
			phosec=6.3E12,
              ...
              Condition.Condition(uname="lys-1A-8.5um",
                        pucks_and_pins=[
					# Selected good crystals
                                        ["CPS1716", [10,11,12]],
                                       ],
...
# Iwata root
root_dir="/isilon/users/target/target/Staff/kuntaro/160930/"
       	...
       	for cond in conditions:
				...
				print rwidth,rheight
                                ...
                                schfile,raspath=lm.rasterMaster(scan_id,scan_mode,cond.v_beam,cond.h_beam,scanv_um,
                                        scanh_um,vstep_um,hstep_um,gxyz,sphi,att_idx=att_idx,distance=300.0,exptime=0.02)
