...
class UserESA():
    ...
    def makeCondList(self):
        ...
        for cols in self.contents:
            ...
            ln2_flag            = 0 if cols[14] == "No" else 1 # modified 200603 HM
            pin_flag            = cols[15]
            zoom_flag           = 0 if cols[16] == "no" else 1
            ...
            #for BL32XU modified by HM 2020/06/04
            distance_calc = math.floor(self.calcDist(wavelength, resolution_limit)/10)*10 # by N.Mizuno at 2020/02/06
            distance = distance_calc if distance_calc >125 else 125 # 125 mm is set as minimum distance        
