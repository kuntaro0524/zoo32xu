...
if __name__=="__main__":
    ...
    xmin,xmax,ymin,ymax,cenx,ceny = cip.makeEnvelope(roi_xy)
    outimage = "raster.png"
    cip.drawRasterSquare(xmin, xmax, ymin, ymax, cenx, ceny, outimage)
    ...
    cip.drawRasterSquare(xmin, xmax, ymin, ymax, ox, oy, outimage)
